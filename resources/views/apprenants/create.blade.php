            ...
            <div class="p-6 text-gray-900 dark:text-gray-100">
                ...
                <form method="POST" action="{{ route('apprenants.store') }}" class="space-y-6">
                    ...
                    <div>
                        ...
                        <input id="lieu_naissance" name="lieu_naissance" type="text" value="{{ old('lieu_naissance') }}" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm dark:bg-gray-700 dark:border-gray-600">
                    </div>
