            ...
            <div class="p-6 text-gray-900">
                ...
                <form method="POST" action="{{ route('filieres.update', $filiere) }}" class="space-y-6">
                    ...
                    <div>
                        ...
                        <input id="nom_filiere" name="nom_filiere" type="text" value="{{ old('nom_filiere', $filiere->nom_filiere) }}" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm bg-white text-gray-900" required>
                    </div>
