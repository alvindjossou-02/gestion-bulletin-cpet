...
<div class="page-container">
    <div class="page-header">
        <div class="header-back">
            <a href="{{ route('audit-logs.index') }}" class="btn-back">← Retour aux logs</a>
        </div>
        ...
        <div class="detail-section">
            ...
            <div class="detail-grid">
                ...
                <div class="detail-item full-width">
                    ...
                    <p><code class="user-agent">{{ $log->user_agent ?? 'N/A' }}</code></p>
                </div>
            </div>
        </div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        @elseif(strlen($value) > 50)
                                            <code title="{{ $value }}">{{ substr($value, 0, 50) }}...</code>
                                        @else
                                            <code>{{ $value }}</code>
                                        @endif
                                    </td>
