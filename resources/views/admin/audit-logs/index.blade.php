...
<div class="page-container">
    ...
    <div class="filters-card">
        <form method="GET" action="{{ route('audit-logs.index') }}" class="filters-form">
            <div class="filter-group">
                <label for="search">Rechercher</label>
                <input type="search" id="search" name="search" placeholder="Rechercher dans la description..." value="{{ request('search') }}">
            </div>
            ...
            <div class="filter-group">
                ...
                <select id="days" name="days">
                    ...
                    <option value="1" {{ request('days') === '1' ? 'selected' : '' }}>Dernier jour</option>
            ...
            <a href="{{ route('audit-logs.index') }}" class="btn-reset">Réinitialiser</a>
            <a href="{{ route('audit-logs.export', request()->query()) }}" class="btn-export">📥 Exporter CSV</a>
        </form>
    </div>
                ...
                <tbody>
                    @foreach($logs as $log)
                        <tr class="log-row log-{{ $log->action }}">
                            ...
                            <td>
                                <small class="bg-gray-100 px-2 py-1 rounded">{{ $log->model }}</small>
                                @if($log->model_id)
                                    <br>
                            ...
                            <td>
                                <a href="{{ route('audit-logs.show', $log) }}" class="btn-small btn-view">👁️ Voir</a>
                            </td>
                        </tr>
                    @endforeach
                </tbody>
