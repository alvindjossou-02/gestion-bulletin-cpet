            ...
            <div class="p-6 text-gray-900">
                ...
                <form method="POST" action="{{ route('matieres.update', $matiere) }}" class="space-y-6">
                    ...
                    <div>
                        ...
                        <input id="nom_matiere" name="nom_matiere" type="text" value="{{ old('nom_matiere', $matiere->nom_matiere) }}" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm bg-white text-gray-900" required>
                    </div>

                    <div>
                        <label for="coefficient" class="block text-sm font-medium text-gray-700">Coefficient</label>
                        <input id="coefficient" name="coefficient" type="number" min="1" max="10" value="{{ old('coefficient', $matiere->coefficient) }}" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm bg-white text-gray-900" required>
                    </div>
