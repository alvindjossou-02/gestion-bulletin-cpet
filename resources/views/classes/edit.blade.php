            ...
            <div class="p-6 text-gray-900 dark:text-gray-100">
                ...
                <form method="POST" action="{{ route('classes.update', $classe) }}" class="space-y-6">
                    ...
                    <div>
                        ...
                        <input id="nom_classe" name="nom_classe" type="text" value="{{ old('nom_classe', $classe->nom_classe) }}" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm dark:bg-gray-700 dark:border-gray-600" required>
                    </div>
