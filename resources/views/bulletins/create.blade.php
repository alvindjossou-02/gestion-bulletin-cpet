            ...
            <div class="p-6 text-gray-900 dark:text-gray-100">
                ...
                <form method="POST" action="{{ route('bulletins.store') }}" class="space-y-6">
                    ...
                    <div>
                        ...
                        <input type="number" name="moyenne_generale" id="moyenne_generale" min="0" max="20" step="0.5" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm dark:bg-gray-700 dark:border-gray-600" required value="{{ old('moyenne_generale') }}">
                    </div>

                    <div>
                        <label for="rang" class="block text-sm font-medium text-gray-700 dark:text-gray-300">Rang</label>
                        <input type="number" name="rang" id="rang" min="1" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm dark:bg-gray-700 dark:border-gray-600" required value="{{ old('rang') }}">
                    </div>

                    <div>
                        <label for="appreciation" class="block text-sm font-medium text-gray-700 dark:text-gray-300">Appréciation</label>
                        <textarea name="appreciation" id="appreciation" rows="4" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm dark:bg-gray-700 dark:border-gray-600">{{ old('appreciation') }}</textarea>
                    </div>
