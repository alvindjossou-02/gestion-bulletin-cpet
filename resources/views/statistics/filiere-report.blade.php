...
@section('title', 'Rapport Filière - Gestion Bulletin CPET')
    ...
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
            <div class="p-6 text-gray-900 dark:text-gray-100">
                <h1 class="text-2xl font-bold mb-6">Rapport Filière: {{ $filiere->nom_filiere }}</h1>
                        ...
                        <tbody>
                            @foreach($stats['apprenants'] as $apprenant)
                                <tr class="border-b dark:border-gray-700">
                                    ...
                                    <td class="px-4 py-2">{{ $apprenant['classe'] }}</td>
                ...
                @else
                    <p class="text-gray-500">Aucun apprenant dans cette filière.</p>
                @endif
