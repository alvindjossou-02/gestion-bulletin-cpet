            ...
            <div class="p-6 text-gray-900 dark:text-gray-100">
                ...
                <form method="POST" action="{{ route('notes.store') }}" class="space-y-6">
                    ...
                    <div>
                        ...
                        <input type="number" name="note" id="note" min="0" max="20" step="0.5" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 bg-white text-gray-900" required value="{{ old('note') }}">
                    </div>
