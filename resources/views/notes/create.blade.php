...
@section('title', 'Ajouter Note - Gestion Bulletin CPET')
            ...
            <div class="p-6 text-gray-900 dark:text-gray-100">
                ...
                <form method="POST" action="{{ route('notes.store') }}" class="space-y-6">
                    ...
                    <div>
                        ...
                        <input type="number" name="note" id="note" min="0" max="20" step="0.5" class="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg dark:bg-gray-700 dark:text-white focus:outline-none focus:ring-2 focus:ring-blue-500" required value="{{ old('note') }}">
                    </div>
                    ...
                    <div class="flex gap-4 pt-6">
                        ...
                        <a href="{{ route('notes.index') }}" class="flex-1 px-4 py-2 bg-gray-600 text-white font-semibold rounded-lg hover:bg-gray-700 transition text-center">
                            Annuler
                        </a>
                    </div>
                </form>
