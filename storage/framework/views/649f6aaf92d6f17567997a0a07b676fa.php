            ...
            <div class="p-6 text-gray-900 dark:text-gray-100">
                ...
                <form method="POST" action="<?php echo e(route('apprenants.store')); ?>" class="space-y-6">
                    ...
                    <div>
                        ...
                        <input id="nom" name="nom" type="text" value="<?php echo e(old('nom')); ?>" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm dark:bg-gray-700 dark:border-gray-600" required>
                    </div>

                    <div>
                        <label for="prenom" class="block text-sm font-medium text-gray-700 dark:text-gray-300">Prénom</label>
                        <input id="prenom" name="prenom" type="text" value="<?php echo e(old('prenom')); ?>" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm dark:bg-gray-700 dark:border-gray-600" required>
                    </div>

                    <div>
                        <label for="matricule" class="block text-sm font-medium text-gray-700 dark:text-gray-300">Matricule</label>
                        <input id="matricule" name="matricule" type="text" value="<?php echo e(old('matricule')); ?>" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm dark:bg-gray-700 dark:border-gray-600" required>
                    </div>
                    ...
                    <div>
                        ...
                        <input id="date_naissance" name="date_naissance" type="date" value="<?php echo e(old('date_naissance')); ?>" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm dark:bg-gray-700 dark:border-gray-600" required>
                    </div>
