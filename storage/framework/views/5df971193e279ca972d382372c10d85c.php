            ...
            <div class="p-6 text-gray-900">
                ...
                <form method="POST" action="<?php echo e(route('filieres.store')); ?>" class="space-y-6">
                    ...
                    <div>
                        ...
                        <input id="nom_filiere" name="nom_filiere" type="text" value="<?php echo e(old('nom_filiere')); ?>" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm bg-white text-gray-900" required>
                    </div>
