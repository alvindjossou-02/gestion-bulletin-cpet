            ...
            <div class="p-6 text-gray-900 dark:text-gray-100">
                ...
                <form method="POST" action="<?php echo e(route('absences.store')); ?>" class="space-y-6">
                    ...
                    <div>
                        ...
                        <input type="date" name="date_absence" id="date_absence" value="<?php echo e(old('date_absence')); ?>" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 bg-white text-gray-900" required>
                    </div>

                    <!-- Justification -->
                    <div class="flex items-center">
                        <input type="checkbox" name="justifiee" id="justifiee" value="1" class="rounded border-gray-300 text-blue-600 focus:ring-blue-500" <?php echo e(old('justifiee') ? 'checked' : ''); ?>>
                    ...
                    <div>
                        ...
                        <input type="text" name="motif" id="motif" value="<?php echo e(old('motif')); ?>" placeholder="Ex: Maladie, Rendez-vous médical, etc." class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 bg-white text-gray-900">
                    </div>
